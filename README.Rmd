...
This is basic example of what a basic universe-wide reference generated with dverse. For customization ideas see `?DT::datatable()`, `?knitr::kable()`, and the examples in the [dverse articles](https://maurolepore.github.io/dverse/articles).
